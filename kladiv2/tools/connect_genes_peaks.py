...
from kladiv2.core.adata_interface import wraps_functional, get_peak_and_tss_data, add_peak_gene_distances
from kladiv2.core.utils import project_sparse_matrix
...
@wraps_functional(adata_extractor = get_peak_and_tss_data, adata_adder = add_peak_gene_distances, 
    del_kwargs = ['peaks','gene_id','chrom','start','end','strand'])
def get_distance_to_TSS(max_distance = 6e5, promoter_width = 3000,*, peaks, gene_id, chrom, start, end, strand, genome_file):
