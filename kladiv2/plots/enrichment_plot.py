...
def plot_enrichment(ax, ontology, results,*, label_genes = [],
    ...
    if show_genes:
        for j, p in enumerate(ax.patches):
            ...
            ax.text(0.1, _y, compact_string(genes[j], max_wordlen=10, join_spacer = ', ', label_genes = label_genes), ha="left", color = text_color)